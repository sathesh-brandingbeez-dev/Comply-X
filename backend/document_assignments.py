...
async def update_assignment(
    ...
    if assignment.assigned_to_user_id == current_user.id:
        ...
        can_update = True
    elif current_user.permission_level in [PermissionLevel.ADMIN, PermissionLevel.SUPER_ADMIN]:
        can_update = True
...
async def create_cross_department_tag(
    ...
    doc_access = DocumentAccess(
        ...
        can_read=True,
        can_download=(tag.access_level in [PermissionLevel.EDITOR, PermissionLevel.ADMIN]),
        can_edit=(tag.access_level in [PermissionLevel.EDITOR, PermissionLevel.ADMIN]),
